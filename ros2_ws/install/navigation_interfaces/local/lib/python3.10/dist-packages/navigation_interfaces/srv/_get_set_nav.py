...
class Metaclass_GetSetNav(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_interfaces.srv.GetSetNav')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from navigation_interfaces.srv import _get_set_nav
...
class GetSetNav(metaclass=Metaclass_GetSetNav):
    from navigation_interfaces.srv._get_set_nav import GetSetNav_Request as Request
    from navigation_interfaces.srv._get_set_nav import GetSetNav_Response as Response
