...
#ifndef NAVIGATION_INTERFACES__SRV__DETAIL__GET_SET_NAV__FUNCTIONS_H_
#define NAVIGATION_INTERFACES__SRV__DETAIL__GET_SET_NAV__FUNCTIONS_H_
...
/// Initialize srv/GetSetNav message.
/**
...
/// Finalize srv/GetSetNav message.
/**
...
/// Create srv/GetSetNav message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navigation_interfaces__srv__GetSetNav_Request__init().
...
/// Destroy srv/GetSetNav message.
/**
 * It calls
 * navigation_interfaces__srv__GetSetNav_Request__fini()
...
/// Check for srv/GetSetNav message equality.
/**
...
/// Initialize array of srv/GetSetNav messages.
/**
...
/// Finalize array of srv/GetSetNav messages.
/**
 * It calls
 * navigation_interfaces__srv__GetSetNav_Request__fini()
...
/// Create array of srv/GetSetNav messages.
/**
 * It allocates the memory for the array and calls
 * navigation_interfaces__srv__GetSetNav_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetSetNav messages.
/**
 * It calls
 * navigation_interfaces__srv__GetSetNav_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetSetNav message array equality.
/**
...
/// Copy an array of srv/GetSetNav messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navigation_interfaces__srv__GetSetNav_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navigation_interfaces
...
/**
 * It calls
 * navigation_interfaces__srv__GetSetNav_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_navigation_interfaces
...
/**
 * It allocates the memory for the array and calls
 * navigation_interfaces__srv__GetSetNav_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navigation_interfaces
...
/**
 * It calls
 * navigation_interfaces__srv__GetSetNav_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAVIGATION_INTERFACES__SRV__DETAIL__GET_SET_NAV__FUNCTIONS_H_
