...
struct BTNode{ // node used for Binary  Tree (named funny so as to not clash with rclcpp::node)
    // Attributes
    string letter;
    BTNode *leftChild;
    BTNode *rightChild;
    ...
    BTNode(string aLetter, BTNode *aLeftChild, BTNode *aRightChild){
        letter = aLetter;
...
Description:
    ...
    For the actual encoding/decoding:
     ...
     -> a (mostly balanced) binary tree will be used for translating from morse code to english,
    ...
    "node" is used in both the context of the binary tree and this whole file, sorry about that, 
    but this is the convention I'm used to, so to avoid confusion on my end, i'm sticking with it.
...
BTNode *treeRoot;          // root node of the binary tree used to translate from morse code to english 
    ...
    treeRoot = new BTNode(" ",
        ...
        new BTNode("e", 
                new BTNode("i", 
                    ...
                    new BTNode("u", 
                        new BTNode("f", nullptr, nullptr), 
                        new BTNode("$", 
                            new BTNode("$", 
                                new BTNode("?", nullptr, nullptr), 
                                nullptr), 
                            new BTNode("2", nullptr, nullptr)
                        )
                    )
            ), 
            new BTNode("a", 
                new BTNode("r", 
                    new BTNode("l", nullptr, nullptr), 
                    new BTNode("$",
                        new BTNode("$", 
                            nullptr, 
                            new BTNode(".", nullptr, nullptr)),
                ...
                new BTNode("w", 
                    new BTNode("p", nullptr, nullptr), 
                    new BTNode("j", 
                        nullptr, 
                        new BTNode("1", nullptr, nullptr)
                    )
                )
            )
        ), 
        ...
        new BTNode("t", 
            new BTNode("n", 
                new BTNode("d", 
                    ...
                    new BTNode("x", nullptr, nullptr)
                ), 
                new BTNode("k", 
                    new BTNode("c", nullptr, nullptr), 
                    new BTNode("y", nullptr, nullptr)
                )
            ), 
            new BTNode("m", 
                new BTNode("g", 
                    new BTNode("z", 
                        new BTNode("7", nullptr, nullptr), 
                        new BTNode("$", 
                            nullptr, 
                            new BTNode(",", nullptr, nullptr))), 
                    new BTNode("q", nullptr, nullptr) 
                ), 
                new BTNode("o", 
                    new BTNode("$",
                        new BTNode("8", nullptr, nullptr),
                        nullptr
                    ),
                    new BTNode("$", 
                        new BTNode("9", nullptr, nullptr),
                        new BTNode("0", nullptr, nullptr)
                    )
                )
            )
        )
