...
class ArmStepperDriverNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('arm_step_pin', 15)            # Jetson Board Pin 15 (Hardware PWM)
        self.declare_parameter('arm_dir_pin', 13)             # Jetson Board Pin 13 (Direction - Full 3.3V Push-Pull)
        self.declare_parameter('arm_enable_pin', 16)          # Jetson Board Pin 16 (Enable)
        ...
        self.declare_parameter('gripper_step_pin', 32)       # Jetson Board Pin 32 (Hardware PWM)
        self.declare_parameter('gripper_dir_pin', 29)        # Jetson Board Pin 29 (Direction - Full 3.3V Push-Pull)
        self.declare_parameter('gripper_enable_pin', 33)     # Jetson Board Pin 33 (Enable)
