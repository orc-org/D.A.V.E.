...
class GPSnode : public rclcpp::Node {
    public:
        GPSnode() : Node("GPSnode"), count_(0) {
            ...
            bearingPublisher = this->create_publisher<navigation_interfaces::msg::BearingString>("bearingTopic", 1);
            positionPublisher = this->create_publisher<navigation_interfaces::msg::PositionString>("currentCoordinates", 1);
    ...
    private:
        void timer_callback(){
            ...
            auto bearingMessage = navigation_interfaces::msg::BearingString();
            bearingMessage.bearing = getBearing();

            auto positionMessage = navigation_interfaces::msg::PositionString();
