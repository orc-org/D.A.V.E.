...
class Metaclass_GetNav(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_interfaces.srv.GetNav')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from navigation_interfaces.srv import _get_nav
...
class GetNav(metaclass=Metaclass_GetNav):
    from navigation_interfaces.srv._get_nav import GetNav_Request as Request
    from navigation_interfaces.srv._get_nav import GetNav_Response as Response
