...
#include "navigation_interfaces/srv/detail/get_nav__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces::srv::GetNav_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigation_interfaces::srv::GetNav_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigation_interfaces::srv::GetNav_Request *>(
    untyped_ros_message);
...
{
  return &navigation_interfaces::srv::typesupport_fastrtps_cpp::_GetNav_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = navigation_interfaces::srv::GetNav_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigation_interfaces::srv::GetNav_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<navigation_interfaces::srv::GetNav_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &navigation_interfaces::srv::typesupport_fastrtps_cpp::_GetNav_Response__handle;
}
...
{
  return &navigation_interfaces::srv::typesupport_fastrtps_cpp::_GetNav__handle;
}
