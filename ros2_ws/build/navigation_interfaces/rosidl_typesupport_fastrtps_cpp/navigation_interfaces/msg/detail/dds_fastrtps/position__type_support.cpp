...
#include "navigation_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const navigation_interfaces::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  navigation_interfaces::msg::Position & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigation_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigation_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  return &navigation_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigation_interfaces, msg, Position)() {
  return &navigation_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
