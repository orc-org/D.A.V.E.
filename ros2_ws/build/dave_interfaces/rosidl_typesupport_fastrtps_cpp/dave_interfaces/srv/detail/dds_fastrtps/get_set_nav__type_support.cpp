...
#include "dave_interfaces/srv/detail/get_set_nav__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dave_interfaces::srv::GetSetNav_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::GetSetNav_Request & ros_message)
{
  // Member: function2call
  cdr >> ros_message.function2call;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dave_interfaces::srv::GetSetNav_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::GetSetNav_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::GetSetNav_Request *>(
    untyped_ros_message);
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, GetSetNav_Request)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
cdr_serialize(
  const dave_interfaces::srv::GetSetNav_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::GetSetNav_Response & ros_message)
{
  // Member: returnedmessage
  cdr >> ros_message.returnedmessage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dave_interfaces::srv::GetSetNav_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::GetSetNav_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::GetSetNav_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, GetSetNav_Response)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav_Response__handle;
}
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, GetSetNav)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_GetSetNav__handle;
}
