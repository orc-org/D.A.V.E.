...
#include "dave_interfaces/msg/detail/bearing__rosidl_typesupport_fastrtps_c.h"
...
using _Bearing__ros_msg_type = dave_interfaces__msg__Bearing;
...
size_t get_serialized_size_dave_interfaces__msg__Bearing(
  const void * untyped_ros_message,
...
static uint32_t _Bearing__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dave_interfaces__msg__Bearing(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dave_interfaces
size_t max_serialized_size_dave_interfaces__msg__Bearing(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dave_interfaces__msg__Bearing;
    is_plain =
      (
...
static size_t _Bearing__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dave_interfaces__msg__Bearing(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dave_interfaces, msg, Bearing)() {
