...
#ifndef NAVSYSTEM__SRV__DETAIL__GET_NAV__FUNCTIONS_H_
#define NAVSYSTEM__SRV__DETAIL__GET_NAV__FUNCTIONS_H_
...
#include "navsystem/srv/detail/get_nav__struct.h"
 ...
 * calls
 * navsystem__srv__GetNav_Request__init().
...
/**
 * It calls
 * navsystem__srv__GetNav_Request__fini()
 ...
 * navsystem__srv__GetNav_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * navsystem__srv__GetNav_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navsystem__srv__GetNav_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navsystem
...
/**
 * It calls
 * navsystem__srv__GetNav_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_navsystem
...
/**
 * It allocates the memory for the array and calls
 * navsystem__srv__GetNav_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navsystem
...
/**
 * It calls
 * navsystem__srv__GetNav_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAVSYSTEM__SRV__DETAIL__GET_NAV__FUNCTIONS_H_
